...
def main():
    ...
    # ✅ [핵심 수정] 아카이브 백업을 HTML 생성보다 먼저 실행
    # → html_generator가 docs/archive를 스캔할 때 오늘 날짜 파일도 포함되어
    #   "지난 브리핑" 링크에 오늘 날짜가 정상적으로 표시됨
    ...
    html = analyze_and_generate_html(
        all_data, ANTHROPIC_API_KEY, channels_data=channels, gh_repo=GITHUB_REPO
    )
